...
describe("Synopsys Tools Parameter test", () => {
    ...
    context('Blackduck command preparation', () => {
        ...
        beforeEach(() => {
            sandbox = sinon.createSandbox();
            const tempDir = process.cwd();
            coverityStateFile = path.join(tempDir, "bd_input.json");
            synopsysToolsParameter = new SynopsysToolsParameter(tempDir);
        });
        ...
        //     Object.defineProperty(inputs, 'BLACKDUCK_SCAN_FULL', {value: 'test'})
        //     Object.defineProperty(inputs, 'BLACKDUCK_SCAN_FAILURE_SEVERITIES', {value: process.cwd()})
        //     Object.defineProperty(inputs, 'BLACKDUCK_AUTOMATION_FIXPR', {value: ''})
        //     Object.defineProperty(inputs, 'BLACKDUCK_AUTOMATION_PRCOMMENT', {value: ''})
