...
describe("Validator test", () => {
    ...
    context('Polaris validation', () => {
        ...
        it('should return mandatory fields missing error for validatePolarisInputs', function () {
            ...
            expect(polarisValidationErrors[0]).contains(['[bridge_polaris_accessToken,bridge_polaris_branch_name,bridge_polaris_assessment_types] - required parameters for polaris is missing'])
        });
    });
