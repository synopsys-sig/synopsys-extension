export enum ErrorCode {
    ...
    FAILED_TO_GET_PULL_REQUEST_ID_FOR_CURRENT_BUILD = 120,
    FAILED_TO_GET_PULL_REQUEST_ID_FROM_SOURCE_BRANCH = 121,
    MISSING_AZURE_TOKEN = 122,
    INVALID_COVERITY_INSTALL_DIRECTORY = 123,
